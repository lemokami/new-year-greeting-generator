export const quotes = [
  ...
  'The New Year has brought another chance for us to set things right and to open up a new chapter in our lives. Unlike what most people think it is never too late to be what you wish to be.new years card with religious message.',
  ...
  'At precisely the moment you feel like giving up, victory is always within reach. Remember this moving into the New Year.We will open the book. Its pages are blank. We are going to put words on them ourselves. The book is called Opportunity, and its first chapter is New Year’s Day',
];
